...
class UserChatsConsumer(AsyncWebsocketConsumer):
    ...
    async def connect(self):
        ...
        try:
            ...
            if not self.user or not self.user.is_authenticated:
                logger.warning("Unauthenticated user attempting to connect to user chats")
            ...
            logger.info(f"User {self.user.username} joining user chats group: {self.user_chats_group}")
            ...
            await self.accept()
            logger.info(f"UserChatsConsumer: User {self.user.username} connected to user chats")
    ...
    async def disconnect(self, close_code):
        ...
        try:
            logger.info(f"UserChatsConsumer disconnect - Code: {close_code}, User: {getattr(self, 'user', 'Unknown')}")
